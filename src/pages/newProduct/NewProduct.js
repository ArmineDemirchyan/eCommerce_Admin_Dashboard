  ...
  return (
    ...
    <form className="addProductForm">
      ...
      <div className="addProductItem">
        ...
        <input type="text" name="description" placeholder="Despriction..." onChange={handleChange} />
      </div>
      <div className="addProductItem">
        <label>Price</label>
      ...
      <div className="addProductItem">
        ...
        <input type="text" name="categories" placeholder="e.g. jeans,shirt" onChange={handleCat}/>
      </div>
      <div className="addProductItem">
        <label>Stock</label>
